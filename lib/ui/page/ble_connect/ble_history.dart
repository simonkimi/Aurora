...
class BleSendHistory extends StatelessWidget {
  const BleSendHistory({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildAppBar(context, title: '发送历史'),
      body: Observer(
        builder: (_) {
          return ListView(
            children: bluetoothStore.sendHistory.map((e) {
              return Card(
                child: ListTile(
